...
export function AboutPage() {
    ...
    const agencies = bootstrap.data?.agencies ?? [];
    const statistics = bootstrap.data?.statistics ?? {
        totalResearch: 0,
        participatingAgencies: 0,
        sdgsCovered: 0,
        latestPublications: 0,
    };
    return (
        <div>
            ...
            <section className="bg-gradient-to-br from-[#1E3A8A] via-[#1E3A8A] to-[#2D4BA0] text-white">
                <div className="max-w-[1200px] mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 text-center">
                    ...
                    <p className="text-blue-100 leading-relaxed max-w-3xl mx-auto">
                        The Regionwide Integrated Knowledge Management System (RIKMS) is a centralized digital
                        platform designed to support the management, accessibility, and dissemination of
            ...
            <section className="max-w-[1200px] mx-auto px-4 sm:px-6 py-10 sm:py-16">
                <div className="grid md:grid-cols-2 gap-10 items-center">
                    <div>
                        <h2 className="text-[#1E3A8A] mb-4 text-xl sm:text-2xl" style={{ fontWeight: 700 }}>
                            What is RIKMS?
                        </h2>
                        <div className="space-y-4 text-[#374151] leading-relaxed">
                            <p>
                                The Regionwide Integrated Knowledge Management System (RIKMS) serves as a
                                centralized repository of research studies conducted by government agencies,
                                research consortia, and academic institutions within the Davao Region.
                            </p>
                            <p>
                                The platform enhances research visibility, accessibility, and collaboration
                                among stakeholders while supporting evidence-based decision-making and
                                regional innovation.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-[#F9FAFB] rounded-xl border border-gray-100 p-8 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-[#374151] leading-relaxed">
                                ...
                                collaboration, innovation, and evidence-based development across the Davao
                                Region.
                            </p>
                        </div>
                        ...
                        <div className="bg-[#F9FAFB] rounded-xl border border-gray-100 p-8 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <p className="text-[#374151] leading-relaxed">
                                To provide a secure and accessible platform that enables government agencies,
                                research consortia, and academic institutions to manage, share, and
                                disseminate research studies that support sustainable development and regional
                                growth.
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                    {OBJECTIVES.map((obj) => (
                        ...
                        >
                            ...
                            <h3 className="text-[#1E3A8A] mb-2" style={{ fontSize: "1rem", fontWeight: 600 }}>
                                {obj.title}
                            </h3>
                            <p className="text-sm text-[#6B7280] leading-relaxed">{obj.description}</p>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section className="bg-white py-10 sm:py-16">
                <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
                    ...
                    <p className="text-sm text-[#6B7280] text-center max-w-2xl mx-auto mb-10 leading-relaxed">
                        Research studies within RIKMS are categorized according to the 17 Sustainable
                        Development Goals to demonstrate their contribution to sustainable regional
                        development.
                    </p>
            ...
            <section className="max-w-[1200px] mx-auto px-4 sm:px-6 py-10 sm:py-16">
                <div className="text-center mb-10">
                    ...
                    <p className="text-[#6B7280]">
                        Government agencies, research consortia, and academic institutions in the Davao Region
                    </p>
                </div>
                    ...
                    {agencies.map((agency) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-xs text-[#6B7280] line-clamp-2">{agency.name}</p>
                            </Link>
                        );
                    })}
                </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                        {USER_ROLES.map((role) => (
                            ...
                            >
                                ...
                                <p className="text-sm text-[#6B7280] leading-relaxed">{role.description}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-blue-100 max-w-2xl mx-auto leading-relaxed">
                            RIKMS strengthens research collaboration and innovation across the Davao Region by
                            providing a unified platform for knowledge management, enabling data-driven
                            decision-making and evidence-based policy development for regional growth.
                        </p>
                    </div>
